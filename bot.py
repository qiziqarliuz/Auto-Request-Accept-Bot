...
pr0fess0r_99=Client(
    ...
    bot_token = "5870263435:AAEKxazgZymrxgG1z-z3kpq_zYk6bJznfWw",
    api_id = "3781962",
    api_hash = "acddea6139b003f11066a4d6e070e29e"
)

CHAT_ID=int(1831179319)
...
async def start(client: pr0fess0r_99, message: Message):
    ...
    button=[[
      InlineKeyboardButton("𝚄𝙿𝙳𝙰𝚃𝙴𝚉", url="https://t.me/+di-WgEnsAwNlOTky"),
      InlineKeyboardButton("𝚂𝚄𝙿𝙿𝙾𝚁𝚃", url="https://t.me/qiziqarliuzadmin")
      ],[
      InlineKeyboardButton("𝚂𝚄𝙱𝚂𝙲𝚁𝙸𝙱𝙴", url=f"https://t.me/+di-WgEnsAwNlOTky")
      ]]
